...
public class AospaSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String AOSPA_CPU_MODEL_PROPERTY = "ro.aospa.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelAospa = SystemProperties.get(AOSPA_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelAospa.isEmpty()) {
            return cpuModelAospa;
